...
import 'onbording_copy_copy2_model.dart';
export 'onbording_copy_copy2_model.dart';

class OnbordingCopyCopy2Widget extends StatefulWidget {
  const OnbordingCopyCopy2Widget({super.key});

  @override
  State<OnbordingCopyCopy2Widget> createState() =>
      _OnbordingCopyCopy2WidgetState();
}

class _OnbordingCopyCopy2WidgetState extends State<OnbordingCopyCopy2Widget>
    with TickerProviderStateMixin {
  late OnbordingCopyCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnbordingCopyCopy2Model());
