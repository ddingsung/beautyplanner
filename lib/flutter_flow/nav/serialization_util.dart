  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case SellersRow:
            return SellersRow(data);
          case CartRow:
            return CartRow(data);
          case PlanCategoryRow:
            return PlanCategoryRow(data);
          case SellercustomerRow:
            return SellercustomerRow(data);
          case SearchHistoryRow:
            return SearchHistoryRow(data);
          case RecommendedProductsRow:
          ...
          case OrderHistoryRow:
            return OrderHistoryRow(data);
          case UserRecommendationsRow:
