...
abstract class FlutterFlowTheme {
  ...
  late Color electricBlue2;
  late Color vividSkyBlue;
  late Color vividSkyBlue2;
  late Color moonstone;
  late Color blue98;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color electricBlue = const Color(0xFF92EDFC);
  late Color electricBlue2 = const Color(0xFF61E5FA);
  late Color vividSkyBlue = const Color(0xFF2FDDF8);
  late Color vividSkyBlue2 = const Color(0xFF07CEED);
  late Color moonstone = const Color(0xFF06A3BC);
  late Color blue98 = const Color(0xFFF5FDFF);
}
