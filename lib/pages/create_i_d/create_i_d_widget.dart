...
import 'create_i_d_model.dart';
export 'create_i_d_model.dart';

class CreateIDWidget extends StatefulWidget {
  const CreateIDWidget({super.key});

  @override
  State<CreateIDWidget> createState() => _CreateIDWidgetState();
}

class _CreateIDWidgetState extends State<CreateIDWidget>
    with TickerProviderStateMixin {
  late CreateIDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateIDModel());
