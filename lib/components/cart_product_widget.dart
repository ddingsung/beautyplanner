...
class CartProductWidget extends StatefulWidget {
  ...
  final Future Function()? callbackTest;
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().cartTotalPrice = FFAppState().cartTotalPrice +
          (((widget.parameter5!) -
              ...
              (widget.parameter4!));
      setState(() {});
      FFAppState().cartProductCount = widget.parameter4!;
      setState(() {});
    });
                          ...
                          child: Row(
                            ...
                            children: [
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  FFAppState().cartProductCount =
                                      FFAppState().cartProductCount + -1;
                                  setState(() {});
                                  FFAppState().cartTotalPrice = ((widget
                                              .parameter5!) -
                                          ((widget.parameter5!) *
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  await widget.callbackTest?.call();
                                },
                              ),
                            ],
                          ),
